...
SECRET_KEY = os.getenv(
    "JWT_SECRET_KEY"
)  # ""
ALGORITHM = "HS256"
...
class JWTBearer(HTTPBearer):
    ...
    async def __call__(self, request: Request):
        ...
        if credentials:
            ...
            lst3 = [
                value
                for value in decoded_JWT.keys()
                if value in ["login_id", "canpebid"]
            ]
            if len(lst3) == 0:
                raise HTTPException(
                    status_code=403, detail="Missing key in authorization code."
                )
            return decoded_JWT
        else:
